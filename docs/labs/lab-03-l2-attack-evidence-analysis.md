---
lab: Lab-03
title: Layer-2 Attack Evidence Analysis (ARP/DHCP)
week: 3
module: 2
clos: [CLO-2]
lectures: [L05, L06]
...
instructor-key: teaching/lab-answer-keys/lab-03-answer-key.md
---
...
`teaching/lab-answer-keys/lab-03-answer-key.md` (instructor-only).
