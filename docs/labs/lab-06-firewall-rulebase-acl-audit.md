---
lab: Lab-06
title: Firewall Rulebase Build & ACL Audit (pfSense)
week: 6
module: 3
clos: [CLO-4]
lectures: [L10, L11]
...
instructor-key: teaching/lab-answer-keys/lab-06-answer-key.md
---
...
failure list: `teaching/lab-answer-keys/lab-06-answer-key.md` (instructor-only).
