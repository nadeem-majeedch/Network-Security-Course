---
lab: Lab-07
title: Lab PKI, TLS Configuration Audit
week: 7
module: 4
clos: [CLO-5, CLO-6]
lectures: [L13, L14]
...
instructor-key: teaching/lab-answer-keys/lab-07-answer-key.md
---
...
`teaching/lab-answer-keys/lab-07-answer-key.md` (instructor-only).
