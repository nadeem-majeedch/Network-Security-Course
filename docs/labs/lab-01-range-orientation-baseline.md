---
lab: Lab-01
title: Lab-Range Orientation, Baseline & Topology Documentation
week: 1
module: 1
clos: [CLO-1]
lectures: [L01, L02]
...
instructor-key: teaching/lab-answer-keys/lab-01-answer-key.md
---
...
`teaching/lab-answer-keys/lab-01-answer-key.md` (instructor-only distribution).
