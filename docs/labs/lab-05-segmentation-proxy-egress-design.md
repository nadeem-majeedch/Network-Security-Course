---
lab: Lab-05
title: Segmentation & Proxy Egress Design
week: 5
module: 3
clos: [CLO-3]
lectures: [L09, L12]
...
instructor-key: teaching/lab-answer-keys/lab-05-answer-key.md
---
...
`teaching/lab-answer-keys/lab-05-answer-key.md` (instructor-only).
