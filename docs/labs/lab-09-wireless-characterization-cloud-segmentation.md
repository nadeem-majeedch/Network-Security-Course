---
lab: Lab-09
title: Wireless Characterization + VPC Segmentation
week: 9
module: 5
clos: [CLO-8]
lectures: [L17, L19]
...
instructor-key: teaching/lab-answer-keys/lab-09-answer-key.md
---
...
`teaching/lab-answer-keys/lab-09-answer-key.md` (instructor-only).
