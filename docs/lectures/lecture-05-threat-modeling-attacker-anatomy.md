...
instructor-plan: modules/module-02-network-threats/lectures/lecture-05-threat-modeling-attacker-anatomy.md
---
...
*(Answers: `teaching/answer-keys/answer-key-module-02.md`.)*
